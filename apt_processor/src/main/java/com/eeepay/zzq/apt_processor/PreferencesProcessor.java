package com.eeepay.zzq.apt_processor;

import com.eeepay.zzq.apt_annotation.Preferences;
import com.eeepay.zzq.apt_processor.utils.ElementUtils;
import com.eeepay.zzq.apt_processor.utils.StringUtils;
...
public class PreferencesProcessor extends AbstractProcessor {
    ...
    private static final ClassName SERIALIZEMANAGERCLASS = ClassName.get("com.eeepay.zzq.mmkv_demo.Interface", "PreferencesManager");
